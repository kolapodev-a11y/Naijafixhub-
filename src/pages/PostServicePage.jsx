        ...
        <form onSubmit={handleStep1} className="card p-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input {...step1Form.register('location')} className="input-field" placeholder="e.g. Victoria Island, Lagos" />
          ...
          <div>
            ...
            <input {...step1Form.register('serviceArea')} className="input-field" placeholder="e.g. Lagos Island, Lekki, Victoria Island, Ajah" />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="label">Starting Price (₦) <span className="text-red-500">*</span></label>
              <input {...step1Form.register('startingPrice')} type="number" min="0" className="input-field" placeholder="e.g. 5000" />
            ...
            <div>
              ...
              <input {...step1Form.register('priceLabel')} className="input-field" placeholder="e.g. per visit, per hour" />
            </div>
          </div>
